...
import { useRouter } from 'next/navigation'; // This is the correct import for Next.js 13+ App Router
import { StyleQuiz } from '@/components/StyleQuizComponent';
...
export default function StyleQuizPage() {
  ...
  const handleQuizComplete = async (
    selectedStyles: StyleDefinition[], 
    ...
    <div className="min-h-screen">
      <div className="fixed top-0 left-0 right-0 h-2 bg-neutral">
        <div 
          ...
          style={{ width: `${(selectedStyles?.length || 0) * 20}%` }}
        />
      </div>
      <StyleQuiz 
